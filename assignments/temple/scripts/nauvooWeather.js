...
weatherRequest3.send();
    ...
    document.getElementById('current3').innerHTML= weatherData.main.temp + "&#8457;";
    document.getElementById('maxtemp3').innerHTML= weatherData.main.temp_max + "&#8457;";
    document.getElementById('mintemp3').innerHTML= weatherData.main.temp_min + "&#8457;";
    ...
    document.getElementById('windchill3').innerHTML= fround + "&#8457;";
